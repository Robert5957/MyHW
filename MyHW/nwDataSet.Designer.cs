...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PName", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "ProductName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products where" +
                " unitprice between @untipricefrom and @unitpriceto";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@untipricefrom", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@unitpriceto", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillPNameFuzzy(nwDataSet.ProductsDataTable dataTable, string PName) {
        ...
        public virtual nwDataSet.ProductsDataTable GetDataBy1(string PName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((PName == null)) {
                throw new global::System.ArgumentNullException("PName");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillSearchUnitprice(nwDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> untipricefrom, global::System.Nullable<decimal> unitpriceto) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((untipricefrom.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(untipricefrom.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((unitpriceto.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(unitpriceto.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual nwDataSet.ProductsDataTable GetDataBy(global::System.Nullable<decimal> untipricefrom, global::System.Nullable<decimal> unitpriceto) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((untipricefrom.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(untipricefrom.Value));
            }
